...
//- (NSString *)transCalendar:(NSString *)eStr {
//    if ([eStr isEqualToString:@"Sun"]) {
//        return @"日";
//    }else if ([eStr isEqualToString:@"Mon"]) {
//        return @"一";
//    }else if ([eStr isEqualToString:@"Tue"]) {
//        return @"二";
//    }else if ([eStr isEqualToString:@"Wed"]) {
//        return @"三";
//    }else if ([eStr isEqualToString:@"Thu"]) {
//        return @"四";
//    }else if ([eStr isEqualToString:@"Fri"]) {
//        return @"五";
//    }else if ([eStr isEqualToString:@"Sat"]) {
//        return @"六";
//    }
//    return nil;
//}
