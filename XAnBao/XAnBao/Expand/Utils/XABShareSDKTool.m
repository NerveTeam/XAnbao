...
static NSString * const ShareSDKAppKey = @"16d519627f780";
static NSString * const ShareSDKAppSecret = @"870942be696045d543192122ad220742";
/*****ShareSDK********/
#define K_ShareSDK_AppKey      ShareSDKAppKey
#define K_ShareSDK_AppSecret   ShareSDKAppSecret
//QQAppId16进制 41e2c9d5   QQ41E2C9D5
//新浪
//#define K_Sina_AppKey    @""
//#define K_Sina_AppSecret @""
//QQ
#define K_QQ_AppId       @"1105879810"
#define K_QQ_AppKey      @"zsOLZGS7IwIDncy5"
//微信
#define K_WX_AppID       @"wxcda6d7846dabbad1"
#define K_WX_AppSecret   @"1b4252360d641b7f82aaaad3e24ef6d1"
#define K_Share_Url      @""

@implementation XABShareSDKTool
#pragma mark - ShareSDK 注册

+(void)registerShare
{   //registerApp 初始化SDK并且初始化第三方平台 // @(SSDKPlatformTypeSinaWeibo),
...
//    [shareParams SSDKEnableUseClientShare];
    ...
    //2. 分享,显示分享view  SSUIShareActionSheetController *sheet =
