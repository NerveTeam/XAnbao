...
@interface XABFileViewController ()<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate>
{
...
- (UIView *)topBarView {
    if (!_topBarView) {
        ...
        _topBarView = [_topBarView topBarWithTintColor:ThemeColor title:@"文本" titleColor:[UIColor whiteColor] leftView:self.backBtn rightView:nil responseTarget:self];
